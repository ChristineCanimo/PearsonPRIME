...
<?php  
 ...
 $today = date("Y-m-d");
 $query ="SELECT * FROM initialresult join employees on initialresult.ManagerNumber = employees.PersonNumber join interview on initialresult.ApplicantNumber = interview.ApplicantNumber where initialresult.Result = 'Passed' and interview.Status = 'For Final Interview' and employees.PersonNumber = $li";  
