...
<?php  
 ...
 $today = date("Y-m-d");
 $query ="SELECT * FROM pendingapplicants join employees on pendingapplicants.ManagerNo = employees.PersonNumber join referrals on pendingapplicants.AssignedPosition = referrals.JobTitle where employees.PersonNumber = $li AND FinalResult = 'Passed'";  
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                        <thead>
                          <tr>
                            ...
                            <th>Department</th>
							<th>Manager</th>
							<th>Final Interviewer's Comment</th>
