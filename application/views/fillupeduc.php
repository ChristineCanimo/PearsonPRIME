					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<ul id="progressbar">
								<form class="form-horizontal" action="<?php echo base_url(); ?>index.php/Interview/inserteduc" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="University/College" name="Tschool" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Degree/Course" name="Tdegree" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Year" name="Tfrom" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Year" name="Tto" class="col-xs-10 col-sm-5" />
										</div>
									</div>

										<div class="checkbox">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1">
														<input type="checkbox" name="Tgraduated" value="graduated" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="High School" name="Sschool" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Year" name="Sfrom" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Year" name="Sto" class="col-xs-10 col-sm-5" />
										</div>
									</div>

									<div class="checkbox">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1">
														<input type="checkbox" name="Sgraduated" value="graduated" />
														<span class="lbl"> Graduated</span>
													</label>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Elementary School" name="Pschool" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Year" name="Pfrom" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Year" name="Pto" class="col-xs-10 col-sm-5" />
										</div>
									</div>

									<div class="checkbox">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1">
														<input type="checkbox" name="Pgraduated" value="graduated" />
														<span class="lbl"> Graduated</span>
													</label>
										</div>
