          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <ul id="progressbar">
                <form class="form-horizontal" name="f1" action="<?php echo base_url(); ?>index.php/Interview/inserteduc" method="post">
                          ...
                          <div class="control-group">
                            <div class="checkbox">
                              <label class="col-sm-4 control-label">
                                <input name="form-field-checkbox" type="checkbox" name="others" id="others" onclick="enable_text(this.checked)" class="ace" />
                                <span class="lbl"> Others: </span>
                              </label>
                                <span class="lbl"><input type="text" id="form-field-1" style="font-size: 12px;" placeholder="Other University" name="otheruniv" class="col-xs-10 col-sm-5" disabled="" /> </span>
                  ...
                  <div class="form-group">
                        <div class="col-sm-11">
                          <div class="control-group">
                            <div class="checkbox">
                              <label class="col-sm-4 control-label">
                                <input name="form-field-checkbox" type="checkbox" name="others" id="others" onclick="enable_text1(this.checked)" class="ace" />
                                <span class="lbl"> Others: </span>
                              </label>
                                <span class="lbl"><input type="text" id="form-field-1" style="font-size: 12px;" placeholder="Other University" name="othercourse" class="col-xs-10 col-sm-5" disabled="" /> </span>
                    ...
                    <div class="form-group">
                        <div class="col-sm-11">
                          <div class="control-group">
                            <div class="checkbox">
                              <label class="col-sm-4 control-label">
                                <input class="form-field-checkbox ace" type="checkbox" name="Tgraduated" value="Graduated"   />
...
<![endif]-->
    ...
    //alert(status);
    status=!status; 
    document.f1.otheruniv.disabled = status;
    var isChecked = document.getElementById("others");
    if (isChecked.checked) {
           document.getElementByName("Tschool").disabled = true;
       } else {
         document.getElementById("Tschool").disabled = false;
       }
    }
    //  End -->
    </script>
    ...
    //alert(status);
    status=!status; 
    document.f1.othercourse.disabled = status;
    }
    //  End -->
    </script>
