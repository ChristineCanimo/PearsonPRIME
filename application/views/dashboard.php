                ...
                <div class="row">
                  ...
                  <div class="col-sm-9 infobox-container">
                    <div class="infobox infobox-green">
                      ...
                      <div class="infobox-data"><?php foreach($cntemploys as $cntemploy){?>
                    ...
                    <div class="infobox infobox-blue">
                      ...
                      <div class="infobox-data"><?php foreach($cntpendapplis as $cntpendappli){?>
                        <span class="infobox-data-number"><?php echo $cntpendappli->cntpendappli;?><?php }?></span>
                        <div class="infobox-content">Pending Applicants</div>
                      </div>
                    </div>
                    ...
                    <div class="infobox infobox-pink">
                      ...
                      <div class="infobox-data"><?php foreach($cntinters as $cntinter){?>
                        <span class="infobox-data-number"><?php echo $cntinter->cntinter;?><?php }?></span>
                        <div class="infobox-content">For interview</div>
                      </div>
                    </div>
