          ...
          <ul class="nav ace-nav">
            ...
            <li class="purple dropdown-modal">
              <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="badge badge-important"><?php foreach($cntmanageronlys as $cntmanageronly){?><?php echo $cntmanageronly->cntmanageronly;?><?php }?></span>
              </a>
              ...
              <div class="col-xs-12">
                ...
                <div class="row">
                  <div class="space-6"></div>
                   <div class="col-sm-9 infobox-container main-content-inner">
                    <div class="infobox infobox-green">
                      <div class="infobox-icon">
                        <i class="ace-icon fa fa-users"></i>
                      </div>

                      <div class="infobox-data center"><?php foreach($cntemploys as $cntemploy){?>
                        <span class="infobox-data-number"><?php echo $cntemploy->countperson;?><?php }?></span>
                        <div class="infobox-content">Employees</div>
                      </div>
                    </div>

                    <div class="infobox infobox-blue center">
                      <div class="infobox-icon">
                        <i class="ace-icon fa fa-users"></i>
                      </div>

                      <div class="infobox-data center"><?php foreach($cntpendapplis as $cntpendappli){?>
                        <span class="infobox-data-number"><?php echo $cntpendappli->cntpendappli;?><?php }?></span>
                        <div class="infobox-content">Assessing Applicants</div>
                      </div>
                    </div>
                    ...
                    <div class="infobox infobox-pink">
                      ...
                      <div class="infobox-data center"><?php foreach($cntinitialinters as $cntinitialinter){?>
                        <span class="infobox-data-number"><?php echo $cntinitialinter->cntinitialinter;?><?php }?></span>
                        <div class="infobox-content">For Initial interview</div>
                      </div>
                    </div>
                    ...
                    <div class="infobox infobox-orange">
                      ...
                      <div class="infobox-data center"><?php foreach($cntfinalinters as $cntfinalinter){?>
                        <span class="infobox-data-number"><?php echo $cntfinalinter->cntfinalinter;?><?php }?></span>
                        <div class="infobox-content">For Final interview</div>
                      </div>
                    </div>
                          ...
                          <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="hidden-480">
                                  <span class="label label-success arrowed-in arrowed-in-right"><?php echo $employ->AssignStatus;?></span>
                                </td>
                              </tr>
                              <?php }?>
                            </tbody>
