...
<?php  
 ...
 $today = date("Y-m-d");
 $query ="SELECT * FROM initialresult join employees on initialresult.ManagerNumber = employees.PersonNumber where initialresult.date_added = '$today' and employees.PersonNumber = $li";  
