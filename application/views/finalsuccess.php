...
<center>
                  ...
                  <h3>
                  		<center>
                  	You have successfully submitted the results for the final interview of the applicant. The application will be on a pending status until the admin process the hiring.</h3>
                      </center>
                 <br>

                 <a href="<?php echo base_url(); ?>index.php/Interview/" style="float: right;">Insert New Applicant&nbsp;<i class="ace-icon fa fa-arrow-right bigger-110"></i></a>
