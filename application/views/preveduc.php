          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <ul id="progressbar">
                <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/Interview/updateeduc" method="post">
                  ...
                  <input type="hidden" class="col-sm-3 control-label no-padding-right" placeholder="Enter First Name" name="ApplicantNumber" value="<?php echo $info->ApplicantNumber;?>"/>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="University/College" name="Tschool" class="col-xs-10 col-sm-5" value="<?php echo $educ->Tschool;?>" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Degree/Course" name="Tdegree" class="col-xs-10 col-sm-5" value="<?php echo $educ->Tdegree;?>"/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Year" name="Tfrom" class="col-xs-10 col-sm-5" value="<?php echo $educ->Tfrom;?>"/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Year" name="Tto" class="col-xs-10 col-sm-5" value="<?php echo $educ->Tto;?>"/>
                    </div>
                  </div>

                    <div class="checkbox">
                          <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                            <input type="checkbox" name="Tgraduated" value="graduated" <?php if($educ->Tgraduated == 'graduated') echo " checked='checked' "; ?>/>
