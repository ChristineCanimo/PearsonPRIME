      ...
      <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
        ...
        <ul class="nav nav-list">         
          ...
          <li class="">
            ...
            <ul class="submenu">
              <li class="">
                <a href="<?php echo base_url(); ?>index.php/adminforms/afillupinfo">
                  <i class="menu-icon fa fa-caret-right"></i>
                  New Applicant
                </a>
          ...
          <li class="">
            ...
            <ul class="submenu">
              <li class="">
                <a href="<?php echo base_url(); ?>index.php/adminforms/afillupeduc">
                  <i class="menu-icon fa fa-caret-right"></i>
                  New Hire Form
                </a>
          ...
          <li class="">
            <a href="#" class="dropdown-toggle">
              <i class="menu-icon fa fa-signal"></i>
                 <span class="menu-text">Trackers </span>
            ...
            <ul class="submenu">
              <li class="">
                <a href="<?php echo base_url(); ?>index.php/adminforms/rtracker">
                  <i class="menu-icon fa fa-caret-right"></i>
                  Rewards &amp; Incentive Tracker
                </a>
        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="">Payroll Information</li>

              </li>
              <li class="">Payment Information</li>
            </ul><!-- /.breadcrumb -->
             ...
             <div class="page-header">
              <h1>
                ...
                <small>
                  ...
                  Step 3 of 3: Please fill-up this form for payment information.
                </small>
              </h1>
            </div>
             ...
             <ul id="progressbar">
                ...
                <br>
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Referred Employee" name="ReferredName" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Job Name" name="ReferredJobName" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Job Grade" name="ReferredJobGrade" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Incentive Amount" name="ReferralIncentive" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Date" name="PaymentDate1" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Amount" name="PaidAmount1" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Remaining Amount" name="RemainingBalance1" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
          <br>
