        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="active"> Employee Rewards &amp; Tracker </li>
            </ul><!-- /.breadcrumb -->
...
<?php  
 ...
 $query ="SELECT * FROM employees JOIN referrals WHERE employees.JobTitle = referrals.JobTitle AND employees.Referrer != ' '"; 
 ...
 ?>
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <h3 class="center header bigger lighter blue">Employee Rewards &amp; Incentives</h3>

                    <div class="clearfix">
                      <div class="pull-right tableTools-container"></div>
                    </div>
                    <div class="table-header">
                      Rewards &amp; Incentives Tracker
                    </div>
                    ...
                    <div>
                    <form action="<?php echo base_url(); ?>index.php/rewardpayroll/managepayroll"" method="POST">
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                        <thead>
                          <tr>
                            ...
                            <th class="center">First Payment Status</th>
                            <th class="center">Second Payment Status</th>
                        ...
                        while($row=mysqli_fetch_array($result))
                        {
                          ...
                          echo $first; echo $second; exit();
                          echo '
                          <tr>
                            <td class="center" name="Referrer">'.$row["Referrer"].'</td>
                            <td class="center" name="Name">'.$row["First"].' '.$row["First"].'</td>
                            ...
                            <td>
                              <div class="hidden-sm hidden-xs action-buttons center">
                                ...
                                <button class="green" type="submit" style="cursor: pointer">
