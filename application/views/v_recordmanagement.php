											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
												<thead>
													<tr>
														...
														<th class="center">Interview Status</th>
 ...
 ?>  
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <h3 class="center header bigger lighter blue">Administrators</h3>
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                        <thead>
                          <tr>
                            ...
                            <th class="hidden-480">Person Number</th>
                        ...
                        while($row=mysqli_fetch_array($result))
                        {
                          ...
                          <tr>
                            ...
                            <td class="center"><a href="#">'.$row["First"].'</a></td>
                            <td>'.$row["usertype"].'</td>
                            <td class="hidden-480">'.$row["WorkEmail"].'</td>
                            
                                                        
                            <td class="hidden-480">
                              <span class="label label-sm label-warning">'.$row["AssignStatus"].'</span>
                            </td>
