            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                 ...
                 <a href="<?php echo base_url(); ?>index.php/recordmanagement/tofinal/<?php echo $id =  $id->ApplicantNumber;?><?php }?>" style="float: right;">Proceed to Final Interview&nbsp;<i class="ace-icon fa fa-arrow-right bigger-110"></i></a>
