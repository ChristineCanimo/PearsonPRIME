      ...
      <div class="w3-container" style="padding: 20px;">
        ...
        <br>
          <center><h2>Are you sure you want to sign out?</h2></center>
            ...
            <a href="<?php echo base_url();?>index.php/Login/logout"  class="w3-button w3-text-white w3-margin-right w3-right w3-round-large" style="background-color: #DB0020">Yes</a></button><br>
        </div>
      </div>
      </div>
    </div>
