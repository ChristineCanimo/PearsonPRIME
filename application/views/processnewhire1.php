 ...
 ?>                    <!-- div.dataTables_borderWrap -->
                 ...
                 <?php foreach($newhires as $newhire){?>
                  ...
                  <br>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="House No, Street, Barangay" name="AddressLine" class="col-xs-10 col-sm-5" value ="<?php echo $newhire->AddressLine;?>" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" value ="<?php echo $newhire->City;?>" placeholder="City" name="City" class="col-xs-10 col-sm-5" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="email" id="form-field-1" placeholder="Email Address" value ="<?php echo $newhire->Email;?>" name="Email" class="col-xs-10 col-sm-5" required/>
										</div>
									</div>
									...
									<div class="form-group">
					                    ...
					                    <div class="col-sm-9">
					                    <select name="Gender" id="form-field-1"> &nbsp;&nbsp;<?php echo $newhire->Gender;?>
					                      <option id="form-field-1" value ="<?php echo $newhire->Gender;?>" name="Gender" required=""><?php echo $newhire->Gender;?></option>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Year" value ="<?php echo $newhire->Tgraduated;?>" name="EStatus" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
              ...
              <div class="space-2"></div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Company" value ="<?php echo $newhire->Company;?>" name="Company" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
              ...
              <div class="space-2"></div>
                   ...
                   <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><b> Referrer: </b></label>
                              <div class="col-sm-9">
                              <input type="text" style="padding: 5px;" class="form-control" placeholder="Employee who referred" name="Referrer" value="<?php echo $newhire->Employee;?>">
                            </div>
                   </div>
                 <div class="form-group">
                         ...
                         <select class="chosen-select form-control jobs" style="padding: 5px;" name="AssignedPosition" id="form-field-1" data-placeholder="Job Title" ><?php echo $newhire->AssignedPosition;?>
                                             <option value="<?php echo $newhire->AssignedPosition;?>"><?php echo $newhire->AssignedPosition;?></option>
                  ...
                  <select class="chosen-select form-control depart" name="DepartmentName" id="choose" data-placeholder="Department Name"><?php echo $newhire->DepartmentName;?>
                                     <option value="<?php echo $newhire->DepartmentName;?>"><?php echo $newhire->DepartmentName;?></option>
                   ...
                   <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><b> Manager: </b></label>
                              <div class="col-sm-9">
                              <input type="text" readonly="" id="manager" style="padding: 5px;" class="form-control" placeholder="Manager" name="Manager" value="<?php echo $newhire->Manager;?>">
                            </div>
                   </div>
