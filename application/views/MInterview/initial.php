                          ...
                          <div class="widget-main">
                            ...
                            <div style="padding: 5px;">
                              <label style="float: right;" for="form-field-9">Interviewer : </label>
                                ...
                                <tr>
                                  <td>
                              <label style="float: right; padding: 5px;" for="form-field-8">Comments : </label>
                            </td>
                          </tr>
                              </table>
                            <div style="padding: 5px;">
                            ...
                            <div style="padding: 5px;">
                              ...
                              <label style="float: right;" for="form-field-8">Department : </label>
                                    ...
                                    <td>
                              <input type="text" style="margin:10px;" class="form-control" placeholder="Department" name="Department" required/>
                                    </td>
                                  </tr>
                                  <tr style="padding: 5px;">
                                    <td>
                              ...
                              <label style="float: right;" for="form-field-8">Manager : </label>
                                    ...
                                    <td>
                              <input type="text" style="margin:10px;" class="form-control input-md" placeholder="Manager" name="Manager" required/>
                                    </td>
                                  </tr>
                                  <tr style="padding: 5px;">
                                    <td>
                              <div style="padding: 5px;">
                              <label style="float: right;" for="form-field-8">Position : </label>
                                  </div>
                                    </td>
                                    <td>
                              <input type="text" style="margin:10px;" class="form-control input-md" placeholder="Position" name="Position" required/>
                                    </td>
                                  </tr>
                                </table>
                              </section>
