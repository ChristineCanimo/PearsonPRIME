        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="">Referred Employee Information</li>
            </ul><!-- /.breadcrumb -->
            ...
            <div class="row">
             ...
             <div class="page-header">
              <h1>
                ...
                <small>
                  ...
                  Step 2 of 3: Please fill-up this form for Employee <b>(Referred)</b> information
                </small>
              </h1>
            </div>
             ...
             <ul id="progressbar">
                ...
                <br>
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Business Unit </label>

                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Business Unit" name="AddressLine" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Department" name="Department" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Job Name" name="Jobname  " class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Job Grade </label>

                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Grade" name="Jobname" class="col-xs-10 col-sm-1" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Work E-mail </label>

                    <div class="col-sm-9">
                      <input type="email" id="form-field-1" placeholder="@pearson.com" name="Email" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="tel" id="form-field-1" placeholder="Contact" name="Contact" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
          <br>
