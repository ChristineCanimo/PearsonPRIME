        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="active">For Final Interview</li>
              <li class="active">Applicants for Final Interview</li>
            </ul><!-- /.breadcrumb -->
...
<?php  
 ...
 $query ="SELECT * FROM `initialresult` JOIN `interview` ON initialresult.ApplicantNumber = interview.ApplicantNumber WHERE initialresult.Result = 'Passed' AND interview.Status = 'For Final Interview'";  
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                        <thead>
                          <tr>
                            ...
                            <th class="center">Initial Interviewer</th>
                        ...
                        while($row=mysqli_fetch_array($result))
                        {
                          echo ' 
                          <tr>
                            <td class="center">'.$row["ApplicantName"].'
                              
                            </td>
                            <td class="center">'.$row["ReferredBy"].'</td>
                            <td class="center">'.$row["Interviewer"].'</td>
                            <td class="center">'.$row["DepartmentName"].'</td>
                            <td class="center">'.$row["Manager"].'</td>
                            <td class="center">'.$row["AssignedPosition"].'</td>
                            <td class="center">
          ...
          Are you sure you want to withdraw the applicant in the interview?
            ...
            <form action="withdrawfinal" method="post">
              <?php
                        ...
                        {
                          echo '
             <input type="text" value="'.$row["ApplicantNumber"].'" name="ApplicantNumber">
               ';
                          }   
                          ?> 
        </div>
