				...
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" action="<?php echo base_url(); ?>index.php/Interview/updateinfo" method="post">
									<?php foreach($personals as $personal){?>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> First Name </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="First Name" name="FirstName" class="col-xs-10 col-sm-5" value="<?php echo $personal->FirstName;?>" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Middle Name" name="MiddleName" class="col-xs-10 col-sm-5" value="<?php echo $personal->MiddleName;?>" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Last Name" name="LastName" class="col-xs-10 col-sm-5" value="<?php echo $personal->LastName;?>" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="House No, Street, Barangay" name="AddressLine" class="col-xs-10 col-sm-5" value="<?php echo $personal->AddressLine;?>" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="City" name="City" class="col-xs-10 col-sm-5" value="<?php echo $personal->City;?>" required/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="email" id="form-field-1" placeholder="Email Address" name="Email" class="col-xs-10 col-sm-5" value="<?php echo $personal->Email;?>" required/>
										</div>
									</div>
									...
									<div class="form-group">
					                    ...
					                    <select name="Gender" id="form-field-1"> &nbsp;&nbsp;
					                      <option id="form-field-1" value="<?php echo $personal->Gender;?>" name="gender" required=""><?php echo $personal->Gender;?></option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="tel" id="form-field-1" placeholder="Contact" name="Contact" class="col-xs-10 col-sm-5" value="<?php echo $personal->Contact;?>" required/>
										</div>
									</div>
					                  ...
					                  <div class="form-group">
										...
										<div class="col-sm-9">
					                    <input type="date" class="col-xs-10 col-sm-5" placeholder="Enter Birthday" name="Birthday" value="<?php echo $personal->Birthday;?>" required/>
					                	</div>
					                  </div>

									<input type="hidden" class="col-sm-3 control-label no-padding-right" placeholder="Enter First Name" name="ApplicantNumber" value="<?php echo $personal->ApplicantNumber;?>""/>
        ...
        <div class="modal-body">
          ...
          <form action="<?php echo base_url(); ?>index.php/Interview/cancel" method="post">
          	 <?php foreach($infos as $info){?>
                  ...
                  <input type="hidden" class="col-sm-3 control-label no-padding-right" name="ApplicantNumber" value="<?php echo $info->ApplicantNumber;?>"/>
                   <?php }?> 
