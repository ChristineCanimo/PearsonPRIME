...
<?php  
 ...
 $query ="SELECT * FROM pendingapplicants where status ='For Assessing' ORDER BY `date_added` DESC";  
 ...
 ?>  
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <h3 class="center header bigger blue"><b>Applicants to be Hired</b></h3>
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                        <thead>
                          <tr>
                            ...
                            <th class="hidden-480 center">Applicant Number</th>
                            <th class="center">Applicant Name</th>
                            <th class="center">Final Interviewer</th>
                            <th class="center">Department</th>
                            <th class="center">Job Title</th>
                            <th class="hidden-480 center">Date of the Initial Interview</th>
                        ...
                        while($row=mysqli_fetch_array($result))
                        {
                          ...
                          <tr>
                            ...
                            <td class="center">'.$row["ApplicantNumber"].'</td>
                            <td class="center">'.$row["ApplicantName"].'</td>
                            <td class="center">'.$row["Finalinterviewer"].'</td>
                            <td class="hidden-480 center">'.$row["DepartmentName"].'</td>
                            <td class="center">
                            ...
                            <td class="center">
                              ...
                              <form action="viewassess" method="Post">

                              <input type="hidden" value="'.$row["ApplicantNumber"].'" name="ApplicantNumber">
                                <button class="green btn btn-success btn-xs tooltip-success" data-rel="tooltip" type="submit" title="Process">
