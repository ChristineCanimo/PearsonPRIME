            ...
            <!--/ .can add other functions here-->
                ...
                <div class="row">
                 ...
                 <CENTER>
                  ...
                  <a href="<?php echo base_url(); ?>index.php/Interview" class="btn btn-white btn-primary style=""><i class="ace-icon fa fa-arrow-left bigger-110"></i>&nbsp;Insert New Applicant</a>

                 <?php foreach($ids as $id){?>
                 <a href="<?php echo base_url(); ?>index.php/interviewprocess/" class="btn btn-white btn-primary" >View Applicants for Initial Interview&nbsp;<i class="ace-icon fa fa-arrow-right bigger-110"><?php }?></i></a>
