                          ...
                          <div class="control-group">
                            <div class="checkbox">
                              <label class="col-sm-4 control-label">
                                <input type="checkbox" name="Tschool" id="Tschool" onclick="enable_text(this.checked)" class="ace" />
                                <span class="lbl"> Others: </span>
                              </label>
                                <span class="lbl"><input type="text" id="form-field-1" style="font-size: 12px;" placeholder="Other University" name="Tschool1" class="col-xs-10 col-sm-5" disabled="" /> </span>
                          ...
                          <div class="control-group">
                            <div class="checkbox">
                              <label class="col-sm-4 control-label">
                                ...
                                <span class="lbl"><input type="text" id="form-field-1" style="font-size: 12px;" placeholder="Other Course" name="Tdegree1" id="Tdegree" class="col-xs-10 col-sm-5" disabled="" /> </span>
