...
<style type="text/css">
  ...
  <body class="no-skin">
        ...
        <div class="main-content-inner">
          ...
          <div class="page-content">
            ...
            <div class="page-header">
              <h1>
                <b>New Applicant Form</b>
                <small>
                  <i class="ace-icon fa fa-angle-double-right"></i>
                  Step 3 of 3: Please enter your Application Information.
                </small>
              </h1>
            </div>

                <ul id="progressbar">
                <form class="form-horizontal" name="f1" action="<?php echo base_url(); ?>index.php/Interview/insertapplication" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Company" name="Company" id="Company" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="Job" name="Job" id="Job" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" placeholder="For how long?" id="Duration" name="Duration" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
                </fieldset>
                  ...
                  <div class="checkbox">
                          <label class="col-sm-4 control-label no-padding-right" for="form-field-1">
                            <input type="checkbox" name="NoExperience" onclick="disable(this.checked)" value="No Experience" />
                            <span class="lbl"> No Work Experience</span>
                          </label>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                              ...
                              <div class="col-sm-9">
                              <select name="Desired" id="form-field-1" required=""> &nbsp;&nbsp;
                                <option id="form-field-1" required=""></option>
                  ...
                  <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><b> By: </b></label>
                          ...
                          <select class="chosen-select form-control" name="Employee" id="form-field-1" data-placeholder="Employee Name">
                              ...
                              <input type="hidden" name="Status" value="For Initial Interview">
          <br>
    ...
    //alert(status);
    status=status; 
    document.f1.Company.disabled = status;
    document.f1.Job.disabled = status;
    document.f1.Duration.disabled = status;
    }
    //  End -->
    </script>
