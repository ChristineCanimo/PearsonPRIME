          ...
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              <li>
                ...
                <a href="<?php echo site_url(); ?>/Interview/">Dashboard</a>
              </li>
              ...
              <div class="clearfix">
                    ...
                    <div class="table-header">
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                        <thead>
                          <tr>
                            <th class="center">Job ID</th>
                            <th class="center">Job Title</th>
                            <th class="center">Department</th>
                            <th class="hidden-480 center">Number Needed</th>
                            <th class="hidden-480 center">Date Created</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="center"><?php echo $job->JobTitle;?> </td>
                            <td class="center"><?php echo $job->Department;?></td>
                            <td class="center"><?php echo $job->NoNeeded;?></td>
                            <td class="hidden-480 center"><?php echo $job->DateCreated;?></td>
                            <td class="center"><?php echo $job->Manager;?></td>                            
                         ...
                         <div style="background-color: #EFF3F8; padding: 10px;" class="center">
                        <a class="red btn-primary btn btn-xs tooltip-top" data-toggle="modal" data-target="#add" data-rel="tooltip" title="Add" href="#">
...
<br>
        ...
        <div class="footer-inner">
          <div class="footer-content">
            <span class="smaller-90">
              <span class="light-blue bolder">PACAPE</span>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="color: Blue">Add New Job Vacancy</h4>
        </div>

        <div class="modal-body">
                <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/adminforms/addjob" method="post">
                  <div class="form-group">
                  <br>

                    <div class="col-sm-9">
                      <input type="hidden" id="form-field-1" name="JobId" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                     <select class="chosen-select form-control col-xs-10 col-sm-5" id="JobTitle" name="JobTitle" id="" placeholder="University/College">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                     <select class="chosen-select form-control col-xs-10 col-sm-5" id="Department" name="Department" id="" placeholder="University/College">
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Number Needed </label>

                    <div class="col-sm-9">
                      <input type="number" id="form-field-1" placeholder="Number Needed" name="NoNeeded" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>

                    <input type="hidden" name="DateCreated" value="<?php date_default_timezone_set("Asia/Manila"); echo date("Y-m-d") ?>">
          <br>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" style="color: Blue">Edit Job Vacancy</h4>
        </div>

        <div class="modal-body">

                <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/adminforms/editjob" method="post">
                              <input type="hidden" value="<?php echo $job->JobId;?>" name="JobId">
                              <input type="hidden" value="<?php echo $job->JobTitle;?>" name="JobTitle">
                              <input type="hidden" value="<?php echo $job->Department;?>" name="Department">
                              <input type="hidden" value="<?php echo $job->NoNeeded;?>" name="NoNeeded">
                              <input type="hidden" value="<?php echo $job->DateCreated;?>" name="DateCreated">
                              <input type="hidden" value="<?php echo $job->DateOccupied;?>" name="DateOccupied">
                  <div class="form-group">
                  <br>

                    <div class="col-sm-9">
                      <input type="hidden" id="form-field-1" value="$_POST['JobId']" name="JobId" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" value="$_POST['Department']" placeholder="Department" name="Department" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" id="form-field-1" value="$_POST['NoNeeded']" placeholder="Number Needed" name="NoNeeded" class="col-xs-10 col-sm-5" required/>
                    </div>
                  </div>

                              <input type="hidden" name="DateCreated" value="$_POST['DateCreated']">
          <br>
