        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li> Tracker </li>
              <li class="active"> Referral Incentives </li>
            </ul><!-- /.breadcrumb -->
              ...
              <div class="col-xs-12">
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <h3 class="center header bigger lighter blue"><b> Referral Incentives to be Given Today</b></h3>
...
<br>
                    ...
                    <br>
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                        <thead>
                          <tr>
                            <th class="center">Person Number</th>
                            <th class="center">Employee (Referrer)</th>
                            <th class="hidden-480 center">Newly Hired (Referred)</th>
                            <th class="hidden-480 center">Date Hired</th>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <?php foreach($firsts as $first){?>
                              ...
                              <input type="hidden" value="<?php echo $first->PersonNumber;?>" name="PersonNumber">
                              <input type="hidden" value="<?php echo $first->Referrer;?>" name="Referrer">
                              <input type="hidden" value="<?php echo $first->First;?> <?php echo $first->Last;?> " name="Name">
                              ...
                              <input type="hidden" value="<?php echo $first->Department;?>" name="Department">
                              <input type="hidden" value="<?php echo $first->AssignStatus;?>" name="AssignStatus">

                              <?php echo $first->PersonNumber;?>
                            </td>
                            <td class="center"><?php echo $first->Referrer;?> </td>
                            <td class="center"><?php echo $first->First;?> <?php echo $first->Last;?></td>
                            <td class="hidden-480 center"><?php echo $first->HireDate;?></td>
                            <td class="center"><?php echo $first->JobTitle;?></td>                            
                            <td class="hidden-480 center"><?php echo $first->Department;?></td>
                            <td class="center"><?php echo $first->AssignStatus;?></td>
                            </form><?php }?>
                          </tr>
                        </tbody>
                      </table>
