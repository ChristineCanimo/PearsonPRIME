    ...
    <div class="main-container ace-save-state" id="main-container">
      ...
      <div id="sidebar" class="sidebar      h-sidebar                navbar-collapse collapse          ace-save-state">
        ...
        <ul class="nav nav-list">         
          <li class="">
            <a href="<?php echo base_url(); ?>index.php/adminforms/" class="dropdown-toggle">
              ...
              <div class="col-xs-12">
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <h3 class="center header bigger lighter blue">Manage Payroll</h3>

                    <div class="clearfix">
                      <div class="tableTools-container"></div> 
                    </div>

                    <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/Interview/rewardpayroll" method="post">
                
                <h5>Referral Information:</h5>
                <?php
                $doh = $_POST['HireDate'];
                $hiredate = date('Y-m-d', strtotime("+3 months", strtotime($doh)));

                $incentive = $_POST['Incentive'];
                $First = $incentive /2;
                $Second = $incentive - $First;

                ?>
                <br>
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Referred Employee Name </label>

                    <div class="col-sm-9 ">
                      <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php echo $_POST['Name']; ?> </label>
                      <input type="hidden" id="form-field-1" placeholder="Employee Name" name="ReferredEmployeeName" value="<?php echo $_POST['Name']; ?>" class="col-xs-10 col-sm-5" disabled/>
                    </div>
                  </div>
                  <?php echo number_format((float)$First, 2, '.', '');; ?>
                  <?php echo $incentive; ?>
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Referred Employee Job Name </label>

                    <div class="col-sm-9">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <?php echo $_POST['JobTitle']; ?></label>

                      <input type="hidden" id="form-field-1" placeholder="Job Name" name="ReferredJobName" value="<?php echo $_POST['JobTitle']; ?>" class="col-xs-10 col-sm-5" disabled/>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Referred Employee Job Grade </label>

                    <div class="col-sm-9">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <?php echo $_POST['Grade']; ?> </label>

                      <input type="hidden" id="form-field-1" placeholder="Job Grade" name="ReferredJobGrade" value="<?php echo $_POST['Grade']; ?>" class="col-xs-10 col-sm-5" disabled/>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Referral Incentive </label>

                    <div class="col-sm-9">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <?php echo $_POST['Incentive']; ?></label>

                      <input type="hidden" id="form-field-1" placeholder="Incentive Amount" value="<?php echo $_POST['Incentive']; ?>" name="ReferralIncentive" class="col-xs-10 col-sm-5" disabled/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> <?php echo $hiredate; ?></label>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 0 </label>
                      
                    </div>
                  </div>
Dapat siguro may paid date dito
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Remaining Balance </label>
          ...
          <br>
                  ...
                  <div class="clearfix form-actions">
                    <div class="pull-left   col-md-offset-3 col-md-9">
