...
<html lang="en">
          ...
          <div class="page-content">
            ...
            <div class="page-header">
              <h1>
                ...
                <small>
                  ...
                  Step 2 of 3: Please enter your educational information
                </small>
              </h1>
            </div><!-- /.page-header -->
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <ul id="progressbar">
                <form class="form-horizontal" name="f1" action="<?php echo base_url(); ?>index.php/Interview/updateeduc" method="post">
 ...
 ?>  
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tertiary </label>

                        <div class="col-xs-12 col-sm-5">
                          <select class="chosen-select form-control col-xs-10 col-sm-5" id="Tschool" name="Tschool" id="" placeholder="University/College">
                            <option value="<?php echo $educ->Tschool;?>"><?php echo $educ->Tschool;?></option>
                          ...
                          <div class="control-group">
                            <div class="checkbox">
                              <label class="col-sm-4 control-label">
                                <input type="checkbox" name="Tschool" id="others" onclick="enable_text(this.checked)" class="ace" />
                                <span class="lbl"> Others: </span>
                              </label>
                                <span class="lbl"><input type="text" id="form-field-1" style="font-size: 12px;" placeholder="Other University" name="Tschool1" class="col-xs-10 col-sm-5" value="<?php echo $educ->Tschool;?>" disabled /> </span>
                    ...
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Degree </label>
                        ...
                        <div class="col-xs-12 col-sm-5">
                          <select class="chosen-select form-control col-xs-10 col-sm-5" name="Tdegree" id="" placeholder="Course">
                            <option value="<?php echo $educ->Tdegree;?>"><?php echo $educ->Tdegree;?></option>
                  ...
                  <div class="form-group">
                        <div class="col-sm-11">
                          <div class="control-group">
                            <div class="checkbox">
                              <label class="col-sm-4 control-label">
                                <input type="checkbox" name="Tdegree" id="others" onclick="enable_text1(this.checked)" class="ace" />
                                <span class="lbl"> Others: </span>
                              </label>
                                <span class="lbl"><input type="text" id="form-field-1" style="font-size: 12px;" placeholder="Other Course" name="Tdegree1" class="col-xs-10 col-sm-5" value="<?php echo $educ->Tdegree;?>" disabled/> </span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-5">
                      <select class="chosen-select form-control" id="form-field-select-3" name="Tfrom" id="" placeholder="Year/College">
                          <option value="<?php echo $educ->Tfrom;?>"><?php echo $educ->Tfrom;?></option>
                          <?php
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-5">
                      <select class="chosen-select form-control" id="form-field-select-3" name="Tto" id="" placeholder="Year/College">
                          <option value="<?php echo $educ->Tto;?>"><?php echo $educ->Tto;?></option>
                    ...
                    <div class="form-group">
                        <div class="col-sm-11">
                          <div class="control-group">
                            <div class="checkbox">
                              <label class="col-sm-4 control-label">
                                <input class="form-field-checkbox ace" type="checkbox" name="Tgraduated" value="Graduated" <?php if($educ->Tgraduated == 'Graduated') echo " checked='checked' "; ?>  />
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="<?php echo base_url(); ?>index.php/Interview/backinfo" class="btn btn-primary">Yes</a>
...
<![endif]-->
    ...
    //alert(status);
    status=!status; 
    document.f1.Tschool1.disabled = status;
    ...
    //alert(status);
    status=!status; 
    document.f1.Tdegree1.disabled = status;
    }
    //  End -->
    </script>
    ...
    //alert(status);
    status=!status; 
    document.f1.addprevemploy.disabled = status;
    }
    //  End -->
    </script>
