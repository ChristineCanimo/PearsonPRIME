												...
												<tbody> 
													...
													<tr>
														...
														<td><?php echo $match->Status;?>
															...
															<input type="hidden" class="col-sm-3 control-label no-padding-right" placeholder="Enter First Name" name="ApplicantNumber" value="<?php echo $match->ApplicantNumber;?>"/>
													
														 <input type="hidden" name="Date_added" value="<?php echo $match->Date_added; ?>">
					<br>
                                                       	<td><input type="submit" value="Select This Person">
                                                       	<i class="ace-icon fa fa-arrow-right smaller-110"></i></td>
                                                       </form>
													</tr> <?php }?> 
												</tbody>
											</table>
