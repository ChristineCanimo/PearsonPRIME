                                   ...
                                   foreach($result as $row)
                                    {
                                      echo '
                                         ...
                                         <option value="'.$row["First"].' '.$row["Last"].'">'.$row["First"].' '.$row["Last"].'</option>
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                        <thead>
                          <tr>
                            ...
                            <th class="hidden-480 center">Total Payment</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td class="center">
                              ...
                              <input type="hidden" value="<?php echo $first->EManager;?>" name="EManager">
                            ...
                            <td class="hidden-480 center"><?php echo $first->JobTitle;?></td>
                            <td class="center"><?php echo $first->EManager;?></td>                            
