 ...
 ?>  
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <h3 class="center header bigger blue"><b>Administrators</b></h3>
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                        ...
                        while($row=mysqli_fetch_array($result))
                        {
                          ...
                          <tr>
                            ...
                            <td class="center">'.$row["First"].'</td>
                            <td class="center">'.$row["JobTitle"].'</td>
