...
<?php  
 ...
 $query ="SELECT * FROM employees where AssignStatus ='Active'";  
                          ...
                          <tr>
                            ...
                            <form action="terminate" method="post">
                              <input type="hidden" value="'.$row["PersonNumber"].'" name="PersonNumber">
                                <Button class="btn btn-white btn-info tooltip-success" type = "submit" data-rel="tooltip" title="Terminate">
                                  <i class="ace-icon fa fa-user-times bigger-100"></i>
                                </BUTTON>
                            </form>
                              ...
                              <div class="hidden-md hidden-lg">
                                <div class="inline pos-rel">
                                  ...
                                  <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                    <li>
                                    <form action="terminate" method="post">
                              <input type="hidden" value="'.$row["PersonNumber"].'" name="ApplicantNumber">
                                <Button class="btn btn-white btn-info tooltip-success" type = "submit" data-rel="tooltip" title="Terminate">
                                  <i class="ace-icon fa fa-user-times bigger-100"></i>
                                </BUTTON>
                            </form>
