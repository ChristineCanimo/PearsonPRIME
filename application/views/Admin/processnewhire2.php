							...
							<h1>
								...
								<small>
									<i class="ace-icon fa fa-angle-double-right"></i>
									 Please enter your all data needed.
								</small>
							</h1>
						</div>
<?php  
                  ...
                  ';
                   ...
                   <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><b> Department: </b></label>
                              <div class="col-sm-9">
                              <select class="chosen-select form-control col-xs-10 col-sm-5" id="choose" name="Department" id="" placeholder="University/College">
                               ...
                               foreach($result as $row)
                                {
                                  echo '
                                     ...
                                     <option value="'.$row["Manager"].'">'.$row["DepartmentName"].'</option>
