          ...
          <div class="page-content">
            <!--/ .can add other functions here-->
                ...
                <div class="row">
                 ...
                 <br>
                 <CENTER>
                 <a href="<?php echo base_url(); ?>index.php/Interview" style="" class="btn btn-white btn-primary">&nbsp;Insert New Applicant</a>
                 <a href="<?php echo base_url(); ?>index.php/interviewprocess" style="" class="btn btn-white btn-primary">&nbsp;View List of Applicants For Initial Interview</a>
                 <?php foreach($ids as $id){?>
                 <a href="<?php echo base_url(); ?>index.php/recordmanagement/getdata/<?php echo $id =  $id->ApplicantNumber;?><?php }?>" class="btn btn-white btn-primary">Proceed to Initial Interview&nbsp;</a>
                 </CENTER>
                          </div>
                        </div>
                      </div>
