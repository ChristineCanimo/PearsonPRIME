...
<div class="row">
                  <div class="col-xs-12">
                    ...
                    <h3 class="center header bigger lighter blue"><b> Rewards and Incentives Payroll </b></h3>
...
<?php  
 ...
 $query ="SELECT * FROM `employees` where Referrer != ' ' Group by Referrer";  
 $result = mysqli_query($connect, $query);  
 
 $query1 ="SELECT * FROM employees JOIN referrals on employees.JobTitle = referrals.JobTitle join incentives on employees.PersonNumber = incentives.NumberReferred Where employees.Referrer != ' ' "; 
 ...
 ?>  
                    ...
                    <div class="table-header">
                      <?php $today = date("Y-m-d"); echo date('F', strtotime("-6 months", strtotime($today))); ?>  Referral Incentives To be given this <?php echo date('F'); ?>
                    </div>
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                         <thead>
                          <tr>
                            ...
                            <th class="hidden-480 center">Amount for Second Half</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td class="center">
                              ...
                              <input type="hidden" value="<?php echo $first->SecondHalf;?>" name="SecondHalf">
                            ...
                            <td class="center"><?php echo $first->SecondHalf;?></td>
