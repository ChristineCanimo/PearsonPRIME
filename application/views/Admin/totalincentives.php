        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="">Tracker</li>
              <li class="active">Total Incentives</li>
            </ul><!-- /.breadcrumb -->
                            ...
                            <div class="col-sm-6">
                              <div class="row">
                                <div class="col-sm-11 label label-lg label-info arrowed-in arrowed-right">
                                  <b>Employee Info (Referrer)</b>
                                </div>
                              </div>
                              <h5>
                              <div>
                                <?php foreach($inceninfos as $inceninfo){?>
                                <ul class="list-unstyled spaced">
                                  <li>
                                    <i class="ace-icon fa fa-caret-right blue"></i>Person Number: 
                                    <b class=""><?php echo $inceninfo->PersonNumber;?></b>
                                  </li>

                                  <li>
                                    <i class="ace-icon fa fa-caret-right blue"></i>Name:
                                    <b class=""> <?php echo $inceninfo->FullName;?></b>
                                  </li>

                                  <li>
                                    <i class="ace-icon fa fa-caret-right blue"></i>Date of Hire:
                                    <b class=""><?php echo $inceninfo->HireDate;?></b>
                                  </li>
                                  <li>
                                    <i class="ace-icon fa fa-caret-right blue"></i>Job Title: 
                                    <b class=""><?php echo $inceninfo->JobTitle;?></b>
                                  </li>

                                  <li>
                                    <i class="ace-icon fa fa-caret-right blue"></i>Department: 
                                    <b class=""><?php echo $inceninfo->EDepartment;?></b>
                                  </li>
                                </ul><?php }?>
                              </div></h5>
                            </div><!-- /.col -->
                            ...
                            <div class="col-sm-6">
                              <div class="row">
                                <div class="col-xs-11 label label-lg label-success arrowed-in arrowed-right">
                                  <b>Referral Incentives Information</b>
                                </div>
                              </div>
                              <h5>
                              <div>
                                <ul class="list-unstyled  spaced">
                                  ...
                                  <li>
                                    <?php foreach($cntrefs as $cntreferrer){?>
                                    <i class="ace-icon fa fa-caret-right green"></i>Total Number of Referred Employees:
                                    <b class=""><?php echo $cntreferrer->cntreferrer;?></b>
                                    <?php }?>
                                  ...
                                  <li>
                                    ...
                                    <i class="ace-icon fa fa-caret-right green"></i>Total Incentives Received:
                                    <b class="">Php <?php foreach($ttalrecvs as $ttalrecv){?><?php echo $ttalrecv->treceive;?><?php }?></b>

                                  </li>

                                  <li>
                                    <i class="ace-icon fa fa-caret-right green"></i>Total Incentives to be given:
                                    <b class="">Php <?php foreach($ttlincgivens as $ttlincgiven){?><?php echo $ttlincgiven->Ttlgiven;?><?php }?></b>
                                    

                                  </li>

                                  <li>
                                    <i class="ace-icon fa fa-caret-right green"></i>Incentives to be given this month:
                                    <b class="">Php <?php foreach($firsts as $first){?><?php $fh =  $first->FirstHalf; if($first->FirstHalf != Null) echo $first->FirstHalf; else echo '0' ?></b>
                                    <?php }?>
                                  </li>
                                </ul>
                              </div>
