        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="active">Assessing Applicants</li>
            </ul><!-- /.breadcrumb -->
...
<?php  
 ...
 $query ="SELECT * FROM pendingapplicants ORDER BY `date_added` DESC";  
 ...
 ?>  
                ...
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <h3 class="center header bigger lighter blue">Assessing Applicants</h3>
                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
                        <thead>
                          <tr>
                            ...
                            <th class="hidden-480 center">Date of Interview</th>
                        ...
                        while($row=mysqli_fetch_array($result))
                        {
                          ...
                          <tr>
                            ...
                            <td class="center">'.$row["DepartmentName"].'</td>
                            <td class="center">'.$row["Manager"].'</td>
                            <td class="hidden-480 center">'.$row["AssignedPosition"].'</td>
                            
                                                        
                            <td class="hidden-480 center">
                              <span class="label label-success arrowed-in arrowed-in-right">'.$row["date_added"].'</span>
                            </td>
