				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Matched Records</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						<div class="ace-settings-container" id="ace-settings-container">
							...
							<div class="ace-settings-box clearfix" id="ace-settings-box">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="overflow:auto" autocomplete="on">
												...
												<tbody> 
													...
													<tr>
														<form class="form-horizontal" action="selectmatch" method="post">
														<td class="center">
															<?php echo $match->FirstName;?>
															<input type="hidden" class="col-sm-3 control-label no-padding-right" placeholder="Enter First Name" name="FirstName" value="<?php echo $match->FirstName;?>"/> 
															<input type="text" class="col-sm-3 control-label no-padding-right" placeholder="Enter First Name" name="ApplicantNumber" value="<?php echo $match->ApplicantNumber;?>"/>
														</td>
														<td><?php echo $match->MiddleName;?>
															<input type="hidden" class="col-sm-3 control-label no-padding-right" placeholder="Enter First Name" name="MiddleName" value="<?php echo $match->MiddleName;?>"/>
														</td>
														<td><?php echo $match->LastName;?>
															<input type="hidden" class="col-sm-3 control-label no-padding-right" placeholder="Enter First Name" name="LastName" value="<?php echo $match->LastName;?>"/>
														</td>
														<td class="hidden-480"><?php echo $match->Gender;?>
															<input type="hidden" class="col-sm-3 control-label no-padding-right" placeholder="Enter First Name" name="Gender" value="<?php echo $match->Gender;?>"/>
														</td>
														<td><?php echo $match->Birthday;?>
															<input type="hidden" class="col-sm-3 control-label no-padding-right" placeholder="Enter First Name" name="Birthday" value="<?php echo $match->Birthday;?>"/>
														</td>
														<td><?php echo $match->Status;?>
															<input type="hidden" class="col-sm-3 control-label no-padding-right" placeholder="Enter First Name" name="Status" value="<?php echo $match->Status;?>"/>
														</td>
                                                       	<td><input onclick="alert()" type="submit" value="Select This Person">
                                                       	<i class="ace-icon fa fa-arrow-right smaller-110"></i></td></form>
													</tr> <?php }?> 
												</tbody>
											</table>
										</div>
								...
								<script>
									function myFunction() {
									   alert("You have successfully selected the person.");
							          // or
							          window.open("http://http://localhost/interview/index.php/Interview/selectmatch");
								...
								<form class="form-horizontal" action="<?php echo base_url(); ?>index.php/Interview/fillupinfo1" method="post">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="First Name" name="FirstName" class="col-xs-10 col-sm-5" value="<?php echo $_POST["FirstName"]; ?>" />
										</div>

										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" placeholder="Middle Name" name="MiddleName" class="col-xs-10 col-sm-5" value="<?php echo $_POST["MiddleName"]; ?>"/>
										</div>

										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" placeholder="Last Name" name="LastName" class="col-xs-10 col-sm-5" value="<?php echo $_POST["LastName"]; ?>"/>
										</div>

									<div class="form-group">

										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" placeholder="House No, Street, Barangay" name="AddressLine" class="col-xs-10 col-sm-5" value="<?php echo $_POST["AddressLine"]; ?>"/>
										</div>

										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" placeholder="City" name="City" class="col-xs-10 col-sm-5" value="<?php echo $_POST["City"]; ?>"/>
										</div>

										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" placeholder="Email Address" name="Email" class="col-xs-10 col-sm-5" value="<?php echo $_POST["Email"]; ?>"/>
										</div>
										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" placeholder="Gender" name="Gender" class="col-xs-10 col-sm-5" value="<?php echo $_POST["Gender"]; ?>"/>
										</div>

										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" placeholder="Contact" name="Contact" class="col-xs-10 col-sm-5" value="<?php echo $_POST["Contact"]; ?>"/>
										</div>

										<div class="col-sm-9">
					                    <input type="hidden" class="col-xs-10 col-sm-5" placeholder="Enter Birthday" name="Birthday" value="<?php echo $_POST["Birthday"]; ?>"/>
					                	</div>
					...
					<br>
										...
										<div class="col-md-offset-3 col-md-9">
											...
											<button class="btn btn-info" type="submit">
												...
												Didn't matched to any of these persons
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          Are you sure you want to go back without submitting the form? You might lose the data you entered.
								...
								<form class="form-horizontal" action="<?php echo base_url(); ?>index.php/Interview/prevappmatch" method="post">
									<div class="form-group">

										<div class="col-sm-9">
											<input type="hidden" id="form-field-1" placeholder="First Name" name="FirstName" class="col-xs-10 col-sm-5" value="<?php echo $_POST["FirstName"]; ?>" />
										</div>
        ...
        <div class="modal-body">
          ...
          <form action="<?php echo base_url(); ?>index.php/Interview/cancel" method="post">
            ...
            <?php foreach($infos as $info){?>
                  ...
                  <input type="text" class="col-sm-3 control-label no-padding-right" name="ApplicantNumber" value="<?php echo $info->ApplicantNumber;?>"/>
                   <?php }?> 
        </div>
        <div class="modal-footer">
